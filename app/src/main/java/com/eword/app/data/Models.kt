 ...
 * 一个词条。
 *
 * 词包 v18 的字段填充情况（14,623 词）：
 *   senses        全部有值，合计 33,530 条（真题 10,910 条、词典补充 22,620 条；
 *                 词包里的取值仍是「大纲补充」，旧包兼容，界面上显示「词典补充」）
 *                 每词条数分布：1 条 4,210 · 2 条 4,799 · 3 条 3,263 · 4 条 1,842 ·
 *                 5 条 490 · 6 条 18 · 7 条 1
 *   examples     12,671 词有，合计 41,299 条（上限 5 条/词），每词条数分布：
 *                 1 条 3,435 · 2 条 1,661 · 3 条 1,215 · 4 条 903 · 5 条 5,457；
 *                 没有例句的 1,952 词里 1,918 词 freq > 0（只在题干或选项里出现过，
 *                 见 [freq] 的说明），34 词 freq 也是 0
 ...
 *   inflections    4,578 词有，合计 9,190 条（只收真题原文里出现过的形态）
...
data class WordEntry(
     ...
     *   · 只在题干或选项里出现的 1,918 词：卷面不给题干与选项配译文，一条例句都收不到，
     ...
     *
     * 卷面上查不到这个词时 freq 为 0，界面上不显示徽章（v18 里 34 个）。
     */
