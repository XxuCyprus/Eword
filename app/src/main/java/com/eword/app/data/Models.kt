 ...
 * 一个词条。
 *
 * 词包 v20 的字段填充情况（14,828 词）：
 *   senses        全部有值，合计 35,625 条（真题 13,029 条、词典补充 22,596 条；
 *                 词包里的取值仍是「大纲补充」，旧包兼容，界面上显示「词典补充」）
 *                 每词条数分布：1 条 3,870 · 2 条 4,575 · 3 条 3,881 · 4 条 1,767 ·
 *                 5 条 658 · 6 条 32 · 7 条 17 · 8 条及以上 28
 *   examples     12,870 词有，合计 42,685 条（上限 5 条/词），每词条数分布：
 *                 1 条 3,304 · 2 条 1,639 · 3 条 1,235 · 4 条 1,062 · 5 条 5,630；
 *                 没有例句的 1,958 词里 1,924 词 freq > 0（只在题干或选项里出现过，
